...
import io.github.pleuvoir.chapter03.Config3;

public class ChapterTest03 {
	...
	public void context() {
		...
		Object bean = app.getBean("io.github.pleuvoir.chapter03.CustomFactoryBean");
		System.out.println(bean);	// result： io.github.pleuvoir.base.Fish@6ab7a896
		
		// 前面加个 & 可以拿到原始的
		Object bean2 = app.getBean("&io.github.pleuvoir.chapter03.CustomFactoryBean");
